	 ...
	 viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
        ...
        <div class="card list">
            ...
            <div class="figure">
                ...
                <form action="?action=deleteUti&id='.$uti[0].'" method="POST">';
                    ...
                    <div class="utibutton">
                        ...
                        <button action="?action=deleteUti&id='.$uti[0].'" class="delete" type="submit"> 
                            <svg id="deleteThis" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"  fill="#000000"><path d="M0 0h24v24H0z" fill="none"/><path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"/>
                            </svg> 
                        </button>

                        
                        <button  class="valider" type="submit">
                            <svg id="send" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24"  fill="#000000"><path d="M0 0h24v24H0z" fill="none"/><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/>
                            </svg>
                        </button>
                    </div>'
                    ?>
